...
public class Mission implements Serializable {
    ...
    public Vehicle getVehiculeId() {
        return vehiculeId;
    }

    public void setVehiculeId(Vehicle vehiculeId) {
    ...
    public String toString() {
        return "com.veganet.entities.Mission[ missionId=" + missionId + " ]";
    }
